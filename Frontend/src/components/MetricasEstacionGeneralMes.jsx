...
import { getMetricasEstacionGeneralMes } from "../api/estadisticas.api";

export function MetricasEstacionGeneralMes({ estacionId, anio, mes }) {
    ...
    return (
        <div>
            ...
            {metricas.length > 0 && (
                <div>
                    <h3 className="fw-bold">Detalles por Inversor</h3>
