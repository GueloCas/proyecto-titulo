...
$(document).ready(function(){
	...
	$(".nav-item a").on('click', function() {
		// Remover la clase 'submenu' de todos los elementos
		$(".nav-item").removeClass('submenu');
	
		// Añadir la clase 'submenu' al item seleccionado
